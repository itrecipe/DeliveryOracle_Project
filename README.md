...
원할하지 못했던 의사소통 문제와 뜻이 맞지 않아 힘들때도 있었지만,<br/>
...
-DeliveryOracle 팀장 황근호-

- **아쉬운점** <br/><br/>
결제 모듈을 붙여 보는 작업과, AWS를 활용하여 사이트 배포하기 까지가<br/>
원래 계획이었으나 주어진 시간안에 다 해내지 못한것이 큰 아쉬움으로 남습니다.<br/><br/>
그리고, 원래는 5명이서 작업을 시작하려고 하였으나 두명의 팀원이 중도 포기를 하고 이탈하게 되는<br/>
상황이 생기는 바람에 남은 인원 3명이서 급히 진행 하느라 시간이 많이 지체 되었던 점도 너무 아쉬움이<br/>
크게 남는것 같습니다.<br/><br/>
그렇지만! 열심히 취업 준비를 하며, 포지하지 않고! 추후에도 꾸준히 지속적인 학습을<br/>
통해 시간안에 못해냈던 부분들도 하나씩 추가 해보고 코드 개선도 함께 해보려는 계획과<br/>
의지를 갖고 있습니다.<br/><br/>
