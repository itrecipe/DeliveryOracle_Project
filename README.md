...
단, 하나의 소중한 의견들도 놓치지 않고 적극 반영할 수 있도록 노력 하였고,<br/>
100% 완벽하진 못해도, 함께 노력하고 달려온 결과 성공적으로 프로젝트를 <br/>
완수할 수 있었습니다.
<br/><br/>
-**DeliveryOracle 일동**-
<br/><br/>
...
대해 걱정하고 어떻게 하면 좋을지 고민하며 한달을 보냈던것 같습니다. <br/><br/>

파이널 프로젝트를 진행하며 우여곡절도 많았고 힘든 시간 또한 존재했습니다. <br/>
그럴때마다 혼자가 아닌 팀원들과 함께 소통하며 최선을 다해 볼 수 있는 기회와 <br/>
시간들이 있었기에 서로를 믿어주고 따라주며 함께 성장할 수 있었던 프로젝트였다고 <br/>
생각 합니다.<br/><br/>

원래 저희 팀은 백엔드 2명, 프론트엔드 3명으로 구성된 5인 팀이었습니다. <br/>
프로젝트 기획, 설계, 기능 구현 작업을 함께 진행하는 도중 갑작스레 백엔드 1명, <br/>
프론트 1명이 국비 교육을 중도 포기 하고 학원을 나오지 않는 상황이 발생하였습니다. <br/>
그래서 많이 아쉬웠지만, 남은 인원 3명으로 급히 포지션 변경을 하게 되었고, <br/>
백엔드 2명, 프론트엔드 1명으로 3인 팀이 재구성 되었습니다. 기획을 전면 수정하여 <br/>
다시 작업을 시작 하였고 그로 인해 다른 팀들 보다 시작이 늦어져 시간안에 완성하지 <br/>
못할까봐 걱정이 있었지만, 다행히 시간안에 프로젝트를 완성할 수 있어서 정말 다행이라고 <br/>
생각 합니다. <br/><br/>
