...
- 각자가 맡은 기능이 구현이 되었는지 진행중인지 시작 전인지에 대한 진행 상황을 파악하기 위해<br/>
  팀원들과 사전에 미리 작업을 진행하고 있다면 "진행중" 완료가 되었다면 "완료" 상태 값을<br/>
  찍어 놓고 표시 해두기로 약속하고 모든 팀원이 함께 작업 진행 상황을 공유하며 진행 하였습니다.<br/><br/>
  기능 구현을 해야하는 일정이 되었음에도 아무런 상태값이 보이지 않는다면,<br/>
  팀 회의를 통해 현재 작업 진행 상황을 수시로 점검 및 체크하였고,<br/>
  자신이 담당하고 있는 파트가 아니더라도, 일정에 차질이 없도록 하기 위하여<br/>
  자신이 맡은 작업이 일찍 끝난 사람이 도와서 개발하는 방법 또는 문제해결 방법을<br/>
  찾아보며 함께 고민하여 작업을 진행하였습니다.<br/><br/>
...
원래는 5명으로 팀이 구성되었었고, 기획부터 시작하고 어느정도 틀이 잡히면<br/>
작업을 시작하려고 하였으나, 두명의 팀원이 중도 포기를 하고 교육과정을 그만두는<br/>
상황이 생겼습니다.<br/><br/>
그래서 남은 인원 3명으로 급히 포지션 변경과 기획을 다시 수정 하고 진행 하느라 주어진 시간이
많이 지체 되었고, 프론트엔드 부분을 깔끔하고 예쁘게 만들지 못한것 같아 아쉬움이 크게 남습니다.<br/><br/>
