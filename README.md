...
- 주문 성공이 되었다면, 이번엔 업체 페이지로 이동하여<br/>
  **"현재 주문 상태"** 페이지에 나타나는 주문내역을 확인해보겠습니다.<br/><br/>
...
- 다음은, 관리자 페이지의 일 단위 매출내역이 그래프로 표현되어 보여지도록 구현되었습니다. <br/><br/>
...
그렇지만, 추후에도 꾸준히 지속적인 학습을 통해 시간안에 못해냈던 부분들도 하나씩 추가 해보고<br/>
코드 개선도 해 보려는 계획과 의지를 갖고 있습니다.<br/><br/>
부족하고, 긴 글이지만 읽어주신 여러분들께 감사드립니다!
