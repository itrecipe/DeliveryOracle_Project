...
public class StoreController {
    ...
    private static final String URL="E:\\h\\DeliveryOracle_Project\\FE\\public\\imgs";
    ...
    public int menuedit(@RequestParam("name") String name,
                        @RequestParam("price") int price, @RequestParam(value = "img", required = false) MultipartFile img,
                        @RequestParam("shopid") int storeIds) throws IOException {
    ...
    //댓글 신고하기(받는 값 댓글 아이디 , 댓글 작성자 아이디,신고자 아이디, 신고내용)
    @PostMapping("report")
